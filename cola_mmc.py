...
class MMCQueue:
    ...
    def clientes_promedio_cola(self):
        ...
        Lq = (P0 * (self.tasa_llegada / self.tasa_servicio) ** self.servidores * self.utilizacion) / (math.factorial(self.servidores) * (1 - self.utilizacion) ** 2)
        return Lq
...
if __name__ == "__main__":
    try:
        ...
        cola_mm_c = MMCQueue(llegadas_totales, tiempo_observacion, atendidos_totales, tiempo_servicio, servidores)
